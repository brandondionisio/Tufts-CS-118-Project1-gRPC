...
type WhatsUpClient interface {
	...
	// TODO: add an RPC message called Send that takes a ChatMessage and expects a Success message DONE
	...
	// TODO: add an RPC message called Fetch that takes Empty and returns ChatMessages (note the plural!) DONE
